  ...
  return (
    <div className="project-wrapper">
        ...
        <div className="project">
            ...
            <div className="btn-div">
                <button className="project-btn" onClick={() => openInNewTab('https://github.com/giadaunger/TodoList-Node')}>View code</button>
            </div>
        </div>
        ...
        <div className="project">
            ...
            <div className="btn-div">
                <button className="project-btn" onClick={() => openInNewTab('https://github.com/giadaunger/Book-API')}>View code</button>
            </div>
        </div>
        ...
        <div className="project">
            ...
            <div className="btn-div">
                <button className="project-btn" onClick={() => openInNewTab('https://github.com/giadaunger/Real-time-chat-app')}>View code</button>
            </div>
        </div>
